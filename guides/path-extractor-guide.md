...
it's also available as a [separate package](https://github.com/amzn/ion-java-path-extraction) for ion-java
...
syntaxes (e.g. Fusion, JSONPath, etc.), but the following stripped-down
