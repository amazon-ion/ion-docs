%%%---------------------------------------------------------
%%% This file was generated at 2023-11-10T03:28:48.453-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\newline
% tag::IVM_1_0[]
\mbox{\bf ivm}_{\scriptsize 1.0} ~\equiv~ \mbox{\it{in}\small $\mbox{\bf IVM}$}(\langle 1, 0\rangle )
% end::IVM_1_0[]
\newline
\newline
% tag::systemSymbols_1_0[]
\mbox{\bf systemSymbols}_{\scriptsize 1.0} ~\equiv~ \langle \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\bf sym0}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion\_1\_0}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion\_symbol\_table}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt name}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt version}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt imports}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt symbols}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt max\_id}''}), \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion\_shared\_symbol\_table}''})\rangle 
...
\newline
% tag::Catalog_extend[]
\mbox{\it Catalog\_extend\/}(\mbox{\it c\/}, \mbox{\it s\/}) ~\equiv~ $\`$ \mbox{\bf Catalog} \times \mbox{\bf SharedModule} \rightarrow \mbox{\bf Catalog}\newline
\:\: \setandincrindent
\mbox{\it{in}\small $\mbox{\bf Catalog}$}(\langle \mbox{\it s\/}\rangle \S\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf SharedModule*}$}}) \decrindent
% end::Catalog_extend[]
\newline
\newline
...
\:\mbox{\bf{else}}\:\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\bf sym0})\newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
