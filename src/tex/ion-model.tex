%%%---------------------------------------------------------
%%% This file was generated at 2024-04-04T01:38:51.023-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\newline
% tag::STree[]
\mbox{\bf STree} ~\equiv~ \mbox{\bf SValue} + \mbox{\bf SEexp}
% end::STree[]
\newline
% tag::SValue[]
...
\newline
% tag::SEexp[]
\mbox{\bf SEexp} ~\equiv~ \mbox{(Placeholder for 1.1)}
% end::SEexp[]
\newline
% tag::IVM[]
...
\newline
% tag::Module[]
\mbox{\bf Module} ~\equiv~ \mbox{\bf IVM}\mbox{:specVersion} \times \mbox{\bf SymTok*}\mbox{:symtab}
% end::Module[]
\newline
% tag::SharedModule[]
...
\newline
% tag::IVM_1_1[]
\mbox{\bf ivm}_{\scriptsize 1.1} ~\equiv~  \setandincrindent
\mbox{\it{in}\small $\mbox{\bf IVM}$}(\langle 1,\:1\rangle ) \decrindent
% end::IVM_1_1[]
\newline
\newline
...
\newline
\newline
% tag::currentSpecVersion[]
\mbox{\it currentSpecVersion\/}(\rho) ~\equiv~ \rho\!\downarrow_{\mbox{\scriptsize sysModule}}\!\downarrow_{\mbox{\scriptsize specVersion}}$\`$ \mbox{\bf Environment} \rightarrow \mbox{\bf IVM}
% end::currentSpecVersion[]
\newline
\newline
% tag::currentSymtab[]
\mbox{\it currentSymtab\/}(\rho) ~\equiv~ \langle \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\bf sym0})\rangle \S\rho\!\downarrow_{\mbox{\scriptsize sysModule}}\!\downarrow_{\mbox{\scriptsize symtab}}\S\rho\!\downarrow_{\mbox{\scriptsize docSymbols}}$\`$ \mbox{\bf Environment} \rightarrow \mbox{\bf SymTok*}
% end::currentSymtab[]
\newline
\newline
% tag::expand_STree[]
...
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it t\/}\in \mbox{\bf SValue}\newline
\:\mbox{\bf{then}}\:\langle {\cal X}_{\mbox{\scriptsize\bf SValue}}(\mbox{\it t\/}\mid_{\mbox{\scriptsize $\mbox{\bf SValue}$}},\:\rho)\rangle \newline
\:\mbox{\bf{else}}\:{\cal X}_{\mbox{\scriptsize\bf SEexp}}(\mbox{\it t\/}\mid_{\mbox{\scriptsize $\mbox{\bf SEexp}$}},\:\rho)\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::expand_STree[]
\newline
...
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it step\/} = \mbox{\it p\/}(\mbox{\it currentSpecVersion\/}(\rho))\newline
\:\mbox{\bf{in}}\: \setandincrindent
...
\:\mbox{\bf{then}}\: \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it mod\/} = \mbox{\it bestModule}(\rho\!\downarrow_{\mbox{\scriptsize catalog}},\:\mbox{\it n\/},\:\mbox{\it v\/})\newline
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it t\/}^{\ast} =  \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it mod\/}\mbox{\ooalign{?\cr\hss!\kern .025em\hss}}\:\mbox{\bf{then}}\:\mbox{\it mod\/}\mbox{!}\!\downarrow_{\mbox{\scriptsize module}}\!\downarrow_{\mbox{\scriptsize symtab}}\:\mbox{\bf{else}}\:\langle \rangle \:\mbox{\bf{endif}}\: \decrindent
\newline
\:\mbox{\bf{in}}\:\mbox{\it enforceMaxId\/}(\mbox{\it t\/}^{\ast},\:\mbox{\it n\/},\:\mbox{\it m\/}\mbox{!}) \decrindent
 \decrindent
\newline
\:\mbox{\bf{else}}\: \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it mod\/} = \mbox{\it exactModule}(\rho\!\downarrow_{\mbox{\scriptsize catalog}},\:\mbox{\it n\/},\:\mbox{\it v\/})\newline
\:\mbox{\bf{in}}\:\mbox{\it mod\/}\!\downarrow_{\mbox{\scriptsize module}}\!\downarrow_{\mbox{\scriptsize symtab}} \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
...
\newline
% tag::enforceMaxId[]
\mbox{\it enforceMaxId\/}(\mbox{\it t\/}^{\ast},\:\mbox{\it moduleName\/},\:\mbox{\it maxId\/}) ~\equiv~ $\`$ \mbox{\bf SymTok*} \times \mbox{\bf Unicode} \times \mbox{\bf I} \rightarrow \mbox{\bf SymTok*}\newline
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it l\/} = \#\mbox{\it t\/}^{\ast}\newline
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it l\/} < \mbox{\it maxId\/}\newline
\:\mbox{\bf{then}}\: \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it t\/} = \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\it{in}\small $\mbox{\bf AbsentSym}$}(\langle \mbox{\it moduleName\/},\:\mbox{\it l\/} + 1\rangle ))\newline
\:\mbox{\bf{in}}\:\mbox{\it enforceMaxId\/}(\mbox{\it t\/}^{\ast}\S\langle \mbox{\it t\/}\rangle ,\:\mbox{\it moduleName\/},\:\mbox{\it maxId\/}) \decrindent
\newline
\:\mbox{\bf{else}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it l\/} > \mbox{\it maxId\/}\newline
\:\mbox{\bf{then}}\:\mbox{\it seq\_truncate\/}(\mbox{\it t\/}^{\ast},\:\mbox{\it maxId\/})\newline
...
\:\mbox{\bf{then}}\:\mbox{\it{in}\small $\mbox{\bf Module}$}(\langle \mbox{\it i\/},\:\mbox{\it map\/}(\mbox{\it{in}\small\bf SymTok},\:\mbox{\bf systemSymbols}_{\scriptsize 1.0})\rangle )\newline
...
\:\mbox{\bf{let}}\:\mbox{\it n\/} = {\cal N}_{\mbox{\scriptsize\tt name}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt name}''})\newline
\:\mbox{\bf{and}}\:\mbox{\it v\/} = {\cal N}_{\mbox{\scriptsize\tt version}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt version}''})\newline
\:\mbox{\bf{and}}\:\mbox{\it s\/} = {\cal N}_{\mbox{\scriptsize list}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt symbols}''})\newline
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it n\/} = \mbox{\rm ``{\tt }''}\newline
\:\mbox{\bf{then}}\:\mbox{\it wrong\/}(\mbox{\rm ``{\tt SST has invalid name}''})\newline
\:\mbox{\bf{else}}\:\mbox{\it{in}\small $\mbox{\bf SharedModule}$}(\langle \mbox{\it n\/},\:\mbox{\it v\/},\:\mbox{\it{in}\small $\mbox{\bf Module}$}(\langle \mbox{\bf ivm}_{\scriptsize 1.0},\:{\cal C}_{\mbox{\scriptsize SST.\tt symbols}}(\mbox{\it s\/},\:\mbox{\it n\/},\:1)\rangle )\rangle )\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
 \decrindent
% end::compile_SST[]
\newline
\newline
% tag::compile_SST_symbols[]
{\cal C}_{\mbox{\scriptsize SST.\tt symbols}}(\mbox{\it v\/}^{\ast},\:\mbox{\it moduleName\/},\:\mbox{\it i\/}) ~\equiv~ $\`$ \mbox{\bf Value*} \times \mbox{\bf Unicode} \times \mbox{\bf I} \rightarrow \mbox{\bf SymTok*}\newline
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{if}}\:\#\mbox{\it v\/}^{\ast}=0\newline
\:\mbox{\bf{then}}\:\langle \rangle \newline
...
\:\mbox{\bf{else}}\:\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\it{in}\small $\mbox{\bf AbsentSym}$}(\langle \mbox{\it moduleName\/},\:\mbox{\it i\/}\rangle ))\newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
\:\mbox{\bf{in}}\:\langle \mbox{\it s\/}\rangle \S{\cal C}_{\mbox{\scriptsize SST.\tt symbols}}(\mbox{\it v\/}^{\ast}\dagger1,\:\mbox{\it moduleName\/},\:\mbox{\it i\/} + 1) \decrindent
 \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::compile_SST_symbols[]
\newline
\newline
% tag::expand_SEexp[]
{\cal X}_{\mbox{\scriptsize\bf SEexp}}(\mbox{\it v\/},\:\rho) ~\equiv~ $\`$ \mbox{\bf SEexp} \times \mbox{\bf Environment} \rightarrow \mbox{\bf Value*}\newline
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it currentSpecVersion\/}(\rho) = \mbox{\bf ivm}_{\scriptsize 1.0}\newline
\:\mbox{\bf{then}}\:\mbox{\it wrong\/}(\mbox{\rm ``{\tt Eexp not allowed in Ion 1.0}''})\newline
\:\mbox{\bf{else}}\:\mbox{\it wrong\/}(\mbox{\rm ``{\tt Eexp not implemented}''})\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::expand_SEexp[]
\newline
