%%%---------------------------------------------------------
%%% This file was generated at 2023-11-14T22:40:21.079-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\;\; \setandincrindent
\mbox{\it exactModule}(\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf SharedModule*}$}}, \mbox{\it n\/}, \mbox{\it v\/}) \decrindent
...
\;\; \setandincrindent
\mbox{\it bestModule}(\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf SharedModule*}$}}, \mbox{\it n\/}, \mbox{\it v\/}) \decrindent
...
\:\mbox{\bf{then}}\:\mbox{\it adjust\_length\/}(\mbox{\it s\/}\mbox{!}\!\downarrow_{\mbox{\scriptsize symtab}}, \mbox{\it m\/}\mbox{!})\newline
\:\mbox{\bf{else}}\:\mbox{\it symbol\_padding\/}(\mbox{\it m\/}\mbox{!})\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
\newline
\:\mbox{\bf{else}}\:\mbox{\it exactModule}(\rho\!\downarrow_{\mbox{\scriptsize catalog}}, \mbox{\it n\/}, \mbox{\it v\/})\!\downarrow_{\mbox{\scriptsize symtab}}\newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
...
\:\mbox{\bf{else}}\:\mbox{\it{in}\small $\mbox{\bf Environment}$}(\langle \rho\!\downarrow_{\mbox{\scriptsize catalog}}, \rho\!\downarrow_{\mbox{\scriptsize IVM}}, {\cal C}_{\mbox{\scriptsize\tt imports}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt imports}''}, \rho)\S{\cal C}_{\mbox{\scriptsize\tt symbols}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt symbols}''})\rangle )\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::compile_LST[]
\newline
...
\newline
\newline
% tag::isIonSymbolTable[]
\mbox{\it ionSymbolTable?}(\mbox{\it v\/}) ~\equiv~ \mbox{\it v\/}\!\downarrow_{\mbox{\scriptsize content}}\in \mbox{\bf Struct}\ \wedge\ \#\mbox{\it v\/}\!\downarrow_{\mbox{\scriptsize annots}}\neq 0\ \wedge\ \mbox{\it v\/}\!\downarrow_{\mbox{\scriptsize annots}}\!\downarrow_{0} \cong \mbox{\rm ``{\tt \$ion\_symbol\_table}''}$\`$ \mbox{\bf Value} \rightarrow \mbox{\bf B}
% end::isIonSymbolTable[]
\newline
\newline
% tag::TE_Value[]
...
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it ionSymbolTable?}(\mbox{\it v\/})\newline
