%%%---------------------------------------------------------
%%% This file was generated at 2023-11-30T22:56:02.858-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\:\mbox{\bf{else}}\:\mbox{\it{in}\small $\mbox{\bf SharedModule}$}(\langle \mbox{\it n\/},\:\mbox{\it v\/},\:\mbox{\it{in}\small $\mbox{\bf Module}$}(\langle \mbox{\bf ivm}_{\scriptsize 1.0},\:{\cal C}_{\mbox{\scriptsize SST.\tt symbols}}({\cal N}_{\mbox{\scriptsize list}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt symbols}''}))\rangle )\rangle )\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
 \decrindent
% end::compile_SST[]
...
{\cal C}_{\mbox{\scriptsize SST.\tt symbols}}(\mbox{\it v\/}^{\ast}) ~\equiv~ $\`$ \mbox{\bf Value*} \rightarrow \mbox{\bf Unicode?*}\newline
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{if}}\:\#\mbox{\it v\/}^{\ast}=0\newline
\:\mbox{\bf{then}}\:\langle \rangle \newline
...
\newline
\:\mbox{\bf{in}}\:\langle \mbox{\it t\/}\rangle \S{\cal C}_{\mbox{\scriptsize SST.\tt symbols}}(\mbox{\it v\/}^{\ast}\dagger1) \decrindent
 \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
...
\:\mbox{\bf{endif}}\: \decrindent
\newline
\:\mbox{\bf{and}}\:\mbox{\it s\/}^{\ast} = {\cal C}_{\mbox{\scriptsize LST.\tt symbols}}({\cal N}_{\mbox{\scriptsize list}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt symbols}''}))\newline
...
\newline
\newline
% tag::compile_LST_symbols[]
{\cal C}_{\mbox{\scriptsize LST.\tt symbols}}(\mbox{\it v\/}^{\ast}) ~\equiv~ $\`$ \mbox{\bf Value*} \rightarrow \mbox{\bf SymTok*}\newline
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{if}}\:\#\mbox{\it v\/}^{\ast}=0\newline
\:\mbox{\bf{then}}\:\langle\rangle\newline
...
\newline
\:\mbox{\bf{in}}\:\langle \mbox{\it t\/}\rangle \S{\cal C}_{\mbox{\scriptsize LST.\tt symbols}}(\mbox{\it v\/}^{\ast}\dagger1) \decrindent
 \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::compile_LST_symbols[]
\newline
\newline
