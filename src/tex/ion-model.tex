%%%---------------------------------------------------------
%%% This file was generated at 2023-11-09T02:42:16.781-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\:\mbox{\bf{in}}\:\mbox{\it{in}\small $\mbox{\bf SharedModule}$}(\langle \mbox{\it n\/}, \mbox{\it v\/}, \mbox{\it{in}\small $\mbox{\bf Module}$}(\langle \mbox{\it IVM\_1\_0\/}, {\cal C}_{\mbox{\scriptsize\tt symbols}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt symbols}''})\rangle )\rangle ) \decrindent
 \decrindent
% end::compile_SST[]
\newline
\newline
...
\:\mbox{\bf{and}}\:\rho_{0} = \mbox{\it{in}\small $\mbox{\bf Environment}$}(\langle \mbox{\it c\/}, \mbox{\it IVM\_1\_0\/}, \mbox{\it systemModule\/}(\mbox{\it IVM\_1\_0\/})\!\downarrow_{\mbox{\scriptsize symtab}}\rangle )\newline
