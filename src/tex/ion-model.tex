%%%---------------------------------------------------------
%%% This file was generated at 2023-11-13T19:03:41.940-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\newline
% tag::Module[]
\mbox{\bf Module} ~\equiv~ \mbox{\bf IVM} \times \mbox{\bf SymTok*}
% end::Module[]
\newline
% tag::SharedModule[]
\mbox{\bf SharedModule} ~\equiv~ \mbox{\bf Unicode} \times \mbox{\bf I} \times \mbox{\bf Module}
% end::SharedModule[]
\newline
% tag::Catalog[]
\mbox{\bf Catalog} ~\equiv~ \mbox{\bf SharedModule*}
% end::Catalog[]
\newline
% tag::Environment[]
...
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\bf sym0}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion\_1\_0}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion\_symbol\_table}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt name}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt version}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt imports}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt symbols}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt max\_id}''}),\newline
\mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\rm ``{\tt \$ion\_shared\_symbol\_table}''})\rangle  \decrindent
 \decrindent
...
\newline
\newline
% tag::Module_specVersion[]
\mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize specVersion}} ~\equiv~ \mbox{\it m\/}\!\downarrow_{0}$\`$ \mbox{\bf Module} \rightarrow \mbox{\bf IVM}
% end::Module_specVersion[]
\newline
\newline
% tag::Module_symtab[]
\mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize symtab}} ~\equiv~ \mbox{\it m\/}\!\downarrow_{1}$\`$ \mbox{\bf Module} \rightarrow \mbox{\bf SymTok*}
% end::Module_symtab[]
\newline
\newline
% tag::SharedModule_name[]
\mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize name}} ~\equiv~ \mbox{\it m\/}\!\downarrow_{0}$\`$ \mbox{\bf SharedModule} \rightarrow \mbox{\bf Unicode}
% end::SharedModule_name[]
\newline
\newline
% tag::SharedModule_version[]
\mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize version}} ~\equiv~ \mbox{\it m\/}\!\downarrow_{1}$\`$ \mbox{\bf SharedModule} \rightarrow \mbox{\bf I}
% end::SharedModule_version[]
\newline
\newline
% tag::SharedModule_module[]
\mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize module}} ~\equiv~ \mbox{\it m\/}\!\downarrow_{2}$\`$ \mbox{\bf SharedModule} \rightarrow \mbox{\bf Module}
% end::SharedModule_module[]
\newline
\newline
% tag::SharedModule_symtab[]
\mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize symtab}} ~\equiv~ \mbox{\it m\/}\!\downarrow_{\mbox{\scriptsize module}}\!\downarrow_{\mbox{\scriptsize symtab}}$\`$ \mbox{\bf SharedModule} \rightarrow \mbox{\bf SymTok*}
% end::SharedModule_symtab[]
\newline
\newline
% tag::systemModule[]
...
\mbox{\it best\_match}(\mbox{\it c\/}, \mbox{\it n\/}, \mbox{\it v\/}) ~\equiv~ $\`$ \mbox{\bf Catalog} \times \mbox{\bf Unicode} \times \mbox{\bf I} \rightarrow \mbox{\bf SharedModule?}\newline
\;\; \setandincrindent
\mbox{\it best\_match}(\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf SharedModule*}$}}, \mbox{\it n\/}, \mbox{\it v\/}) \decrindent
% end::best_match_Catalog[]
\newline
\newline
% tag::best_match_Module[]
\mbox{\it best\_match}(\mbox{\it s\/}^{\ast}, \mbox{\it n\/}, \mbox{\it v\/}) ~\equiv~ $\`$ \mbox{\bf SharedModule*} \times \mbox{\bf Unicode} \times \mbox{\bf I} \rightarrow \mbox{\bf SharedModule?}\newline
\;\; \setandincrindent
 \setandincrindent
...
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it s\/}\!\downarrow_{\mbox{\scriptsize name}} \neq \mbox{\it n\/}\newline
\:\mbox{\bf{then}}\:\mbox{\it s\/}^{\ast}_{1}\newline
\:\mbox{\bf{else}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it s\/}\!\downarrow_{\mbox{\scriptsize version}} = \mbox{\it v\/}\ \vee\ \lnot \mbox{\it s\/}^{\ast}_{1}\mbox{\ooalign{?\cr\hss!\kern .025em\hss}}\newline
\:\mbox{\bf{then}}\:\langle \mbox{\it s\/}\rangle \newline
\:\mbox{\bf{else}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it s\/}^{\ast}_{1}\mbox{!}\!\downarrow_{\mbox{\scriptsize version}} = \mbox{\it v\/}\ \vee\ \mbox{\it s\/}^{\ast}_{1}\mbox{!}\!\downarrow_{\mbox{\scriptsize version}} > \mbox{\it s\/}\!\downarrow_{\mbox{\scriptsize version}}\newline
\:\mbox{\bf{then}}\:\mbox{\it s\/}^{\ast}_{1}\newline
\:\mbox{\bf{else}}\:\langle \mbox{\it s\/}\rangle \newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
...
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::best_match_Module[]
\newline
\newline
% tag::Catalog_extend[]
\mbox{\it Catalog\_extend\/}(\mbox{\it c\/}, \mbox{\it s\/}) ~\equiv~ \mbox{\it{in}\small $\mbox{\bf Catalog}$}(\langle \mbox{\it s\/}\rangle \S\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf SharedModule*}$}})$\`$ \mbox{\bf Catalog} \times \mbox{\bf SharedModule} \rightarrow \mbox{\bf Catalog}
% end::Catalog_extend[]
\newline
\newline
...
\newline
% tag::compile_SST[]
\mbox{\it compile\_SST\/}(\mbox{\it s\/}) ~\equiv~ $\`$ \mbox{\bf Struct} \rightarrow \mbox{\bf SharedModule}\newline
\;\; \setandincrindent
 \setandincrindent
...
\:\mbox{\bf{in}}\:\mbox{\it{in}\small $\mbox{\bf SharedModule}$}(\langle \mbox{\it n\/}, \mbox{\it v\/}, \mbox{\it{in}\small $\mbox{\bf Module}$}(\langle \mbox{\bf ivm}_{\scriptsize 1.0}, {\cal C}_{\mbox{\scriptsize\tt symbols}}(\mbox{\it s\/} \odot \mbox{\rm ``{\tt symbols}''})\rangle )\rangle ) \decrindent
 \decrindent
% end::compile_SST[]
\newline
\newline
...
\:\mbox{\bf{then}}\:\langle\rangle\newline
\:\mbox{\bf{else}}\:\langle \mbox{\it{in}\small $\mbox{\bf SymTok}$}(\mbox{\bf sym0})\rangle \S\mbox{\it symbol\_padding\/}(\mbox{\it n\/} - 1)\newline
\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
% end::symbol_padding[]
\newline
...
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it c\/}\in \mbox{\bf String}\ \wedge\ \mbox{\it c\/}\notin \mbox{\bf DotNull}\:\mbox{\bf{then}}\:\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf String}$}}\mid_{\mbox{\scriptsize $\mbox{\bf Unicode}$}}\:\mbox{\bf{else}}\:\mbox{\rm ``{\tt }''}\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
\newline
...
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it i\/} < 1\:\mbox{\bf{then}}\:1\:\mbox{\bf{else}}\:\mbox{\it i\/}\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
\newline
\:\mbox{\bf{else}}\:1\newline
\:\mbox{\bf{endif}}\: \decrindent
...
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it n\/} < 0\:\mbox{\bf{then}}\:\langle \rangle \:\mbox{\bf{else}}\:\langle \mbox{\it n\/}\rangle \:\mbox{\bf{endif}}\: \decrindent
 \decrindent
\newline
...
\:\mbox{\bf{if}}\:\mbox{\it s\/}\mbox{\ooalign{?\cr\hss!\kern .025em\hss}}\:\mbox{\bf{then}}\:\mbox{\it s\/}\mbox{!}\!\downarrow_{\mbox{\scriptsize symtab}}\:\mbox{\bf{else}}\:\langle \rangle \:\mbox{\bf{endif}}\: \decrindent
\newline
...
\:\mbox{\bf{then}}\:\mbox{\it s\/}\mbox{!}\!\downarrow_{\mbox{\scriptsize symtab}}\newline
...
\;\; \setandincrindent
 \setandincrindent
\:\mbox{\bf{let}}\:\mbox{\it t\/}^{\ast} = \mbox{\it systemModule\/}(\rho\!\downarrow_{\mbox{\scriptsize IVM}})\!\downarrow_{\mbox{\scriptsize symtab}}\newline
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it v\/}\mbox{\ooalign{?\cr\hss!\kern .025em\hss}}\newline
\:\mbox{\bf{then}}\: \setandincrindent
...
\:\mbox{\bf{let}}\:\mbox{\it c\/} = \mbox{\it v\/}\mbox{!}\!\downarrow_{\mbox{\scriptsize content}}\newline
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it c\/}\in \mbox{\bf List}\ \wedge\ \mbox{\it c\/}\notin \mbox{\bf DotNull}\:\mbox{\bf{then}}\:\mbox{\it t\/}^{\ast}\S{\cal C}_{\mbox{\scriptsize import}}^{\ast}(\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf List}$}}\mid_{\mbox{\scriptsize $\mbox{\bf Value*}$}}, \rho)\:\mbox{\bf{else}}\:\mbox{\it t\/}^{\ast}\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
\newline
\:\mbox{\bf{endif}}\: \decrindent
\newline
...
\:\mbox{\bf{let}}\:\mbox{\it c\/} = \mbox{\it v\/}\mbox{!}\!\downarrow_{\mbox{\scriptsize content}}\newline
\:\mbox{\bf{in}}\: \setandincrindent
\:\mbox{\bf{if}}\:\mbox{\it c\/}\in \mbox{\bf List}\ \wedge\ \mbox{\it c\/}\notin \mbox{\bf DotNull}\:\mbox{\bf{then}}\:{\cal C}_{\mbox{\scriptsize symbol}}^{\ast}(\mbox{\it c\/}\mid_{\mbox{\scriptsize $\mbox{\bf List}$}}\mid_{\mbox{\scriptsize $\mbox{\bf Value*}$}})\:\mbox{\bf{else}}\:\langle\rangle\:\mbox{\bf{endif}}\: \decrindent
 \decrindent
\newline
\:\mbox{\bf{else}}\:\langle\rangle\newline
\:\mbox{\bf{endif}}\: \decrindent
...
\;\; \setandincrindent
\mbox{\it{in}\small $\mbox{\bf Environment}$}(\langle \rho\!\downarrow_{\mbox{\scriptsize catalog}}, \mbox{\it i\/}, \mbox{\it systemModule\/}(\mbox{\it i\/})\!\downarrow_{\mbox{\scriptsize symtab}}\rangle ) \decrindent
...
\:\mbox{\bf{and}}\:\rho_{0} = \mbox{\it{in}\small $\mbox{\bf Environment}$}(\langle \mbox{\it c\/}, \mbox{\bf ivm}_{\scriptsize 1.0}, \mbox{\it systemModule\/}(\mbox{\bf ivm}_{\scriptsize 1.0})\!\downarrow_{\mbox{\scriptsize symtab}}\rangle )\newline
