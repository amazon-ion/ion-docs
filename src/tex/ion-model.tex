%%%---------------------------------------------------------
%%% This file was generated at 2023-12-07T00:34:03.476-00:00
%%%---------------------------------------------------------
% tag::domains[]
% tag::B[]
...
\langle \mbox{\rm ``{\tt \$ion}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt \$ion\_1\_0}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt \$ion\_symbol\_table}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt name}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt version}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt imports}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt symbols}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt max\_id}''}\rangle ,\newline
\langle \mbox{\rm ``{\tt \$ion\_shared\_symbol\_table}''}\rangle \rangle  \decrindent
 \decrindent
