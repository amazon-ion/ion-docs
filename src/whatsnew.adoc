...
The *module* is a new concept in Ion 1.1.  It contains a list of of strings representing the symbol definitions of a
module and a list of macro definitions.  Modules can be imported from the catalog (they subsume shared symbol tables),
but can also be defined locally.  Modules are referenced as a group to allocate entries in the local symbol table and
local macro table.
