...
bound to a stream of values, and within the macro definition, each parameter’s name is a reference to that stream,
...
least one value.  To continue using our prices example:
