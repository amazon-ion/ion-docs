...
A macro's _signature_ define the syntax of expressions that invoke it, and the set of input values
it acceptable.
...
(Zero-parameter macros—constants—are acceptable but pointless.)
...
specification_ that constraints the data that it produces.
